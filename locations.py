...
descriptions = {  # just going to pick 3 and do those first.
    ...
    "a city hotel room": {"description": None, "inside": True,
                          "electricity": True, "nature": False, "parent": "the city centre"},
    # , "details": place_data.a_city_hotel_room},
    ...
    "a forked tree branch": {"description": None, "inside": False,
                             "electricity": False, "nature": True, "parent": "the nature reserve"},
    # , "details": place_data.up_a_tree},
